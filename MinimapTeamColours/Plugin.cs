...
{
    public static string MOD_NAME = "MinimapTeamColours";
    public static string MOD_VERSION = "1.0.0";
    public static string MOD_GUID = "MinimapTeamColours";
    ...
    public bool OnEnable()
    {
        ...
        try
        {
            ...
            else
            {
                ...
                PatchColour.PatchMinimapTeamColours();
            }
    ...
    public bool OnDisable()
    {
        try
        {
            ...
            PatchColour.resetMinimapTeamColours();
            return true;
        }
        catch (Exception e)
        {
